...
var catalog = []catalogEntry{
	...
	{ErrEmptyOutput, "output.empty",
		"The crypto library reported success but returned an empty result.",
		"This combination of options is not supported by the library — a timestamp together with a disabled certificate-time check is the common case. Retry with the certificate-time check on."},
